  ...
  <%@ include file="../common/header.jsp" %>
   ...
   <h1 style="margin-top:100px;">리띵's Pick!</h1>
        ...
        <div id="div">
            <section>
                <article class="thema">     
                    <a href="LTpick_view.jsp" style="text-decoration:none;"><div>
                        <img src="../../resources/img/big_portfolio_item_2.png" id="thema_pic">
                        <h2 style="text-decoration:none; color: black;">테마제목</h2>
                        <p id="content">국가는 균형있는 국민경제의 성장 및 안정과 적정한 소득의 분배를 유지하고, 시장의 지배와 경제력의 남용을 방지하며, 경제주체간의 조화를 통한 경제의 민주화를 위하여 경제에 관한 규제와 조정을 할 수 있다.</p>
                    </div></a>
                </article>
                 <article class="thema">     
                    <a href="LTpick_view.jsp" style="text-decoration:none;"><div>
