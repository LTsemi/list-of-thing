...
import com.buyme.seul.event.model.vo.PageInfo;

/**
 * Servlet implementation class EventListServlet
 */
@WebServlet("/selectWinList.ev")
public class EventWinnerListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EventWinnerListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list = es.selectEventWinnerList(currentPage, limit);
