...
/**
 * Servlet implementation class ThemaImageServlet
 */
@WebServlet("/tidown.tm")
public class ThemaImageDownloadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ThemaImageDownloadServlet() {
        super();
